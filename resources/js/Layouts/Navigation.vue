...
<template>
    ...
    <div :class="$page.props.showingMobileMenu ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <nav class="mt-10" x-data="{ isMultiLevelMenuOpen: false }">
            ...
            <nav-link :href="route('patients.index')" :active="route().current('patients.index')">
                <template #icon>
            ...
            <nav-link :href="route('medications.index')" :active="route().current('medications.index')">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 6.75h-15m15 0a2.25 2.25 0 0 1-2.25 2.25h-10.5A2.25 2.25 0 0 1 3 6.75m16.5 0V17.25A2.25 2.25 0 0 1 17.25 19.5h-10.5A2.25 2.25 0 0 1 4.5 17.25V6.75m4.5 6.75h6" />
                    </svg>
                </template>
                Medications
            </nav-link>

            <nav-link :href="route('glucose-tests.index')" :active="route().current('glucose-tests.index')">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2m-6 0h6m-6 0a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2m-6 0v2a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-2" />
            ...
            <a v-if="false" class="flex items-center mt-4 py-2 px-6 text-gray-100" href="#" @click="showingTwoLevelMenu = !showingTwoLevelMenu">
